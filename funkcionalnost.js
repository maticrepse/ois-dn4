...
function dodajMeritve() {
	...
	if(bodyMassIndex>25){
		$("#prviVideo").empty();
		$("#prviVideo").html('<div class="row"><div class="col-lg-10">&nbsp</div></div><div class="row"><div class="col-lg-4">&nbsp</div><div class="col-lg-4 alert alert-dismissable alert-danger"><button type="button" class="close" data-dismiss="alert">×</button><strong>Imate prekomerno telesno težo, predlagamo vam: </strong></div><div class="col-lg-4">&nbsp</div></div><div class="row"><div class="col-lg-4">&nbsp</div><div class="flex-video widescreen"><iframe src="https://www.youtube-nocookie.com/embed/qL210_mo0fI" frameborder="0" allowfullscreen=""></iframe></div></div>');
		console.log("Video1");
	}else if(bodyMassIndex<18.5){
		$("#prviVideo").empty();
		$("#prviVideo").html('<div class="row"><div class="col-lg-10">&nbsp</div></div><div class="row"><div class="col-lg-4">&nbsp</div><div class="col-lg-4 alert alert-dismissable alert-danger"><button type="button" class="close" data-dismiss="alert">×</button><strong>Imate premajhno telesno težo, predlagamo vam: </strong></div><div class="col-lg-4">&nbsp</div></div><div class="row"><div class="col-lg-4">&nbsp</div><div class="flex-video widescreen"><iframe src="https://www.youtube-nocookie.com/embed/DvFpT32VbFE" frameborder="0" allowfullscreen=""></iframe></div></div>');
		console.log("Video2");
	}else{
		$("#prviVideo").empty();
		$("#prviVideo").html('<div class="row"><div class="col-lg-10">&nbsp</div></div><div class="row"><div class="col-lg-4">&nbsp</div><div class="col-lg-4 alert alert-dismissable alert-success"><button type="button" class="close" data-dismiss="alert">×</button><strong>Imate idealen indeks telesne mase, svetujemo vam:</strong></div><div class="col-lg-4">&nbsp</div></div><div class="row"><div class="col-lg-4">&nbsp</div><div class="flex-video widescreen"><iframe src="https://www.youtube-nocookie.com/embed/K-Ch9kbtLYQ" frameborder="0" allowfullscreen=""></iframe></div></div>');
		console.log("Video3");
	}
	$.ajaxSetup({
		headers: {"Ehr-Session": sessionId}
