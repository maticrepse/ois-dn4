...
function dodajMeritve() {
	...
	if(bodyMassIndex>25){
		$("#prviVideo").empty();
		$("#prviVideo").html('<div class="row"><div class="col-lg-10">&nbsp</div></div><div class="row"><div class="col-lg-4">&nbsp</div><div class="col-lg-4 alert alert-dismissable alert-danger"><button type="button" class="close" data-dismiss="alert">×</button><strong>Imate prekomerno telesno težo, predlagamo vam: </strong></div><div class="col-lg-4">&nbsp</div></div><div class="row"><div class="col-lg-4">&nbsp</div><div class="col-lg-4"><iframe class="col-sm-12" height="333" frameborder="0" wmode="Opaque" allowfullscreen="" src="https://www.youtube.com/v/qL210_mo0fI"></iframe></div></div>');
		console.log("Video1");
	}else if(bodyMassIndex<18.5){
		$("#prviVideo").empty();
		$("#prviVideo").html('<div class="row"><div class="col-lg-10">&nbsp</div></div><div class="row"><div class="col-lg-4">&nbsp</div><div class="col-lg-4 alert alert-dismissable alert-danger"><button type="button" class="close" data-dismiss="alert">×</button><strong>Imate premajhno telesno težo, predlagamo vam: </strong></div><div class="col-lg-4">&nbsp</div></div><div class="row"><div class="col-lg-4">&nbsp</div><div class="col-lg-4"><iframe class="col-lg-12 col-md-6 col-sm-12 col-xs-12" width="420" height="315" src="https://www.youtube.com/v/DvFpT32VbFE"></iframe></div></div>');
		console.log("Video2");
	}else{
		$("#prviVideo").empty();
		$("#prviVideo").html('<div class="row"><div class="col-lg-10">&nbsp</div></div><div class="row"><div class="col-lg-4">&nbsp</div><div class="col-lg-4 alert alert-dismissable alert-success"><button type="button" class="close" data-dismiss="alert">×</button><strong>Imate idealen indeks telesne mase, svetujemo vam:</strong></div><div class="col-lg-4">&nbsp</div></div><div class="row"><div class="col-lg-4">&nbsp</div><div class="col-lg-4"><iframe class="col-lg-12col-md-6 col-sm-12 col-xs-12" width="420" height="315" src="https://www.youtube.com/v/K-Ch9kbtLYQ"></iframe></div></div>');
		console.log("Video3");
	}
	$.ajaxSetup({
		headers: {"Ehr-Session": sessionId}
